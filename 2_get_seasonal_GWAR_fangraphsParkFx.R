...
park_fx_df = read_csv("1a_park_fx/Fangraphs_PF_2019_3yr.csv") %>% select(PARK, park_factor)
war2_og <- war2_ogg %>% 
...
write_csv(pitcher_exits_2019, "pitcher_exits_2019_fangraphsParkFx.csv")
write_csv(GWAR_2019, "GWAR_2019_fangraphsParkFx.csv")
